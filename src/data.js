        ...
        <ol className="homePage-OL">
          ...
          <div>
            ...
            <ul>
              ...
              <li className="homePage-List">
                The map method is used to iterate through the topDesserts array,
                and for each dessert object, it calls the function passed to it
                and creates a new array with the results of that function call.
                In addition, the map() method creates a new array with the
                result of the function call, it doesn't modify the original
                array
              </li>
              <li className="homePage-List">
                For example, if the first object in the topDesserts array has
                the title "Tiramisu" and the price "$5.00", the function passed
                to the map method would return a list item with the text
                Tiramisu - $5.00.
              </li>
              <li className="homePage-List">
                The result of the map method call is then assigned to the
                listItems variable. This variable holds an array of list items,
                each with a text containing the title and price of a dessert
                from the topDesserts array.
              </li>
              <li className="homePage-List">
